            ...
            <div className="py-md-5">
              <div className="flex flex-wrap justify-start pb-3">
                <div className="w-full heading-section text-left animate-fade-in">
                  <span className="subheading text-lg font-semibold text-gray-600">My Intro</span>
                  <h2 className="mb-4 text-4xl font-bold capitalize">About Me</h2>
                  <p className="text-gray-700">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>

                  <ul className="about-info mt-4 px-0 md:px-2 list-none">
                    <li className="flex mb-2"><span>Name:</span> <span className="ml-2">Clyde Nowitzki</span></li>
                    <li className="flex mb-2"><span>Date of birth:</span> <span className="ml-2">January 01, 1990</span></li>
                    <li className="flex mb-2"><span>Address:</span> <span className="ml-2">San Francisco CA 97987 USA</span></li>
                    <li className="flex mb-2"><span>Zip code:</span> <span className="ml-2">1000</span></li>
                    <li className="flex mb-2"><span>Email:</span> <span className="ml-2">cydenowitzki@gmail.com</span></li>
                    <li className="flex mb-2"><span>Phone: </span> <span className="ml-2">+1-2234-5678-9-0</span></li>
                  </ul>
                </div>
